...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="w-52 text-4xl font-bold">Tomito</h3>
        <ul className="w-52 font-medium text-lg">
          <a href="/">
            <li className="py-0.5">Mutual Funds</li>
          </a>
          <a href="/">
            <li className="py-0.5">ETFs</li>
          </a>
          <a href="/">
            <li className="py-0.5">Fixed Income</li>
          </a>
          <a href="/">
            <li className="py-0.5">Bonds</li>
          </a>
        </ul>
        <ul className="w-52 font-medium text-lg">
          <a href="/">
            <li className="py-0.5">Stocks</li>
          </a>
          <a href="/">
            <li className="py-0.5">Online Trading</li>
          </a>
          <a href="/">
            <li className="py-0.5">Annuities</li>
          </a>
        ...
        <ul className="w-52 font-medium text-lg">
          <a href="/">
            <li className="py-0.5">IRAs</li>
          </a>
          <a href="/">
            <li className="py-0.5">Retirement Products</li>
          </a>
          <a href="/">
            <li className="py-0.5">Retirement Planning</li>
          </a>
          <a href="/">
            <li className="py-0.5">Health Savings Account</li>
          </a>
        </ul>
        <div id="social-group">
          <p>Follow us on</p>
